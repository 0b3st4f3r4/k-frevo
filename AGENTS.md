...
- **2026-09-23.** **A resposta de um pedaço só engana, e a conta independente também.** Em pedaços de dois anos a entrega do corte vai de 0,0079 a 0,1111, com a maior resposta valendo 14,06 vezes a menor; a dispersão medida é de 0,0323 contra os 0,0098 que a conta independente prevê (mais de três vezes), e 7 dos 13 pedaços ficam fora da banda de dois desvios — onde a conta esperaria um em vinte. Nos pedaços de dez anos a razão cai a 1,11 e nenhum pedaço fica fora, mas ali só existem dois pedaços, e duas respostas não fazem dispersão.
- **2026-09-23.** **Nem tudo balança, e é isso que a disciplina compra.** A dependência entre as duas pernas medida nos mesmos pedaços vai de 2,98 a 11,36 nos de dois anos, de 6,46 a 9,13 nos de cinco e de 6,90 a 8,85 nos de dez — e em nenhum pedaço ela chega perto de um, que seria a independência. A conclusão de que as pernas caem juntas **sobrevive** à troca de pedaço; a conclusão sobre quanto custa a promessa do corte **não** sobrevive. Antes desta medição, as duas tinham a mesma cara no papel.
- **2026-09-23.** `estabilidade` ganhou o bloco do pedaço: `janelas` (as fatias, com sobreposição declarada quando o passo é menor), `por_janela` (a mesma pergunta respondida em cada pedaço), `resumo` (menor, maior, dispersão, razão e a fração fora de uma banda declarada) e `banda_independente` (raiz de p(1-p)/n, a conta de quem supõe dias independentes). O auto_teste ganhou as propriedades: as janelas sem sobreposição cabem na série, resposta constante dá dispersão zero, e a banda independente segue a lei da raiz. O caderno E18 traz as duas figuras e as leituras visuais. Livro em 17 capítulos, 19 cadernos, 15 módulos e 102 páginas.
- **2026-09-23.** Defeito de caderno corrigido nesta rodada: a medição por pedaço recebia o **índice** de datas em vez da série, e a dependência saiu 1,0 em todos os pedaços — o caderno devolveu um número plausível e falso. A conferência que pegou foi olhar a lista inteira de respostas em vez de só o resumo. Fica a lição: ao medir por fatia, o objeto que entra é a série fatiada, não o seu índice.
...
- **2026-09-23.** **Os buracos se encaixam em vez de se somar.** A pilha inteira entrega 3,2032 vezes a promessa, contra 2,972 que a soma dos buracos isolados preveria (só a janela longa no mundo mudado 3,0040, só a mudança 2,0996, só o atraso 1,0359 no parado): juntar cegueira de janela, atraso e mundo mudado custa mais do que a soma do que cada um custa sozinho, e a diferença mora no produto, não na adição.
...
- **2026-09-23.** **As legendas estão legíveis, e a medida sustenta a afirmação.** Medido nas 67 legendas do livro: **mediana de 3 linhas**, com 56 delas em três linhas ou menos (3 de uma linha, 21 de duas, 28 de três). O bloco é justificado na mesma largura do texto corrido, e **o corpo é o mesmo do texto** — a altura da caixa da palavra na legenda é idêntica à do corpo (razão 1,000), porque a classe `book` não encolhe legenda, e o \textsf{fontspec} que parecia apontar fonte menor era só o mesmo arquivo de fonte em outro ponto. A suspeita natural (legenda ilegível por tipo pequeno) era falsa, e a leitura da página confirma: bloco com recuo próprio e rótulo destacado.
