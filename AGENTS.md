...
- **2026-09-24.** **A vírgula em modo matemático imprime com espaço depois.** Dentro de `\ensuremath` a vírgula é pontuação do TeX e ganha espaço: 8,224 saía «8, 224» no papel. A vírgula passou a sair entre chaves, e o `conferir_matematica` reprova vírgula decimal solta em matemática, nos dois ramos testados.
