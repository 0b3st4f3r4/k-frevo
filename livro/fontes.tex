...
\addcontentsline{toc}{chapter}{\bibname}
  ...
  SCHOLKOPF, Bernhard; LOCATELLO, Francesco; BAUER, Stefan; KE, Nan Rosemary; KALCHBRENNER, Nal; GOYAL, Anirudh; BENGIO, Yoshua.
  \newblock \textbf{Towards Causal Representation Learning}.
  ...
  SEEGER, Matthias.
  \newblock \textbf{Bayesian Gaussian Process Models: PAC-Bayesian Generalization Error Bounds and Sparse Approximations}.
  \newblock University of Edinburgh, 2003.
  ...
  SEEGER, Matthias.
  \newblock \textbf{PAC-Bayesian generalization bounds for gaussian processes}.
