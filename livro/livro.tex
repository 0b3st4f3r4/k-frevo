...
% -----------------------------------------------------------------------------
% O primeiro capítulo é a raiz: a medição, o corte e o preço de fixar.
% Ele ainda não existe, e é o próximo trabalho: o fracasso concreto dele vem antes
% do texto (AGENTS.md §11).
% -----------------------------------------------------------------------------
