% =============================================================================
% CAPÍTULO 5 — volta 1 (AGENTS.md §6): a forma que o relógio desenha.
%
% O fracasso que o abre, com número na mão: levado à carga elétrica diária da Dinamarca no
% mesmo orçamento de um alarme por ano, o vigia do capítulo 3 dispara 4,2 vezes por ano e
...
Com $C$ igual a um a forma devolve $1/(n+1)$, a conta do primeiro capítulo.
\end{proof}
