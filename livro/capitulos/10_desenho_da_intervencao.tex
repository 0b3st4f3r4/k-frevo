...
de $|x|$ nos dez dias seguintes à soltura dividida pela média de $|x|$ nos dez dias anteriores a
ela: uma razão de um é um mundo que voltou ao que era, e uma razão de meio é um mundo que voltou
com metade da oscilação.
