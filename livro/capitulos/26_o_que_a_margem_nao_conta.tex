...
O que não é honrado é o que acontece \textbf{depois} do rompimento\cite{oconnell2026extreme}. A profundidade média além do corte vai
...
Falta o último caso da frase, e é o mais fundo: a taxa com que a junta cai quando o corte afunda. O
que a margem escondia era um número; o que a taxa esconde é uma inclinação inteira, e um corte só ---
raso ou fundo --- não a dá. É o capítulo que vem.
