...
O domingo consome \numCalendarioDomingoPct\% menos que o dia médio, e essa não é a anomalia de
uma semana: é o perfil de todas as semanas dos cinco anos. Vale medir o tamanho desse perfil
...
O preço aparece na conta do capítulo anterior, lida célula por célula. A janela de
\numCalendarioJanela{} dias já não dá \numCalendarioJanela{} dias de memória a cada decisão:
repartida por $C$ células, cada uma recebe $n/C$ dias, e o alarme mais raro que uma célula
...
com a mesma janela, sobe para \numCalendarioIndiceSemanaAlarmesAno{} alarmes por ano. Nada foi
...
\numCalendarioAmplitudeIndice, é despesa. E o número que decide não é opinião sobre a série: é
a amplitude do perfil dela, medida.

\section{O que fica}

Fica a \textbf{célula}: o calendário é uma partição declarada dos dias, e a regra do capítulo
anterior vale dentro de cada parte, com a memória que sobra para ela. Fica também o preço, que
é aritmético e não se contorna com calibração: $C$ células dividem a memória por $C$ e
multiplicam o orçamento por $C$.
...
fácil, porque a célula está escrita no relógio. Existe uma partição que não está escrita em
lugar nenhum: duas séries que mudam de dependência entre si, sem que nenhuma das duas mude de
