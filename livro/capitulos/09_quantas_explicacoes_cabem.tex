% =============================================================================
% CAPÍTULO 9 — volta 3 (AGENTS.md §6): a geometria do condicionamento.
%
...
curtas, da ordem de dez a trinta dias. E esse número é de \emph{uma} varredura: em
\numCondicionamentoSementesControle{} sementes ele vai de \numCondicionamentoCabemQuatroMenor{} a
...
da medição: o dado identifica uma \textbf{região}, e não um ponto.
...
explicações que sobreviveram, ou se é preciso mexer no mundo de propósito. É essa a pergunta seguinte.
