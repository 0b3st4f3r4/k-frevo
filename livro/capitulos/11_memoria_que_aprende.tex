...
mesma janela erra por \numEsquecimentoPisoDuzentosECinquenta{}, que é pouco. Quem só olha o mundo
...
A outra maneira de estimar o nível não tem tamanho de janela; tem **taxa**.
...
janela perde para a mistura na mesma memória, e a proposição explica: a janela joga fora os dias de
uma vez, e a queda brusca machuca tanto quanto a entrada lenta.

\section{O que cabe prometer}

Falta a conta que decide se um esquecimento **ainda aprende**, e ela depende do tempo que se tem
...
Fica a resposta da travessia, e ela é estreita. O esquecimento mínimo que ainda aprende, neste mundo
e nesta tolerância, é o de memória de vinte e um dias --- uma taxa de \numEsquecimentoMelhorTaxa{} por
...
para essa mesma memória. Quem lembra mais do que isso fica cego à mudança; quem apaga
...
referência a bater, ficou atrás: na mesma memória ela erra mais, o que decide a favor da mistura nos
lugares em que o mundo muda.

O fracasso seguinte não fala do nível, e sim do que o esquecimento joga fora junto com os dias velhos.
A memória apaga os dias, e apaga com eles a **ordem** em que eles vieram --- e é a ordem que diz para
