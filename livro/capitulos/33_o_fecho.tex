...
Trinta e dois capítulos mediram buracos separados: a memória que cega, o atraso do dado, o pedaço
escolhido, a mudança que chega sem avisar, a cauda que vem junto, o passado que não volta, o trabalho
que se gasta, a janela que precisa se escolher, a ordem que era o relógio, o mundo que não foi visto,
a margem que não conta o junto, a taxa que um corte só não dá, o preço do que não se compra. Cada um
tem o seu preço medido, e nenhum foi medido junto com os outros.

Este capítulo mede a promessa do corte com \textbf{três buracos abertos ao mesmo tempo}: a
...
do corte, agora no instrumento inteiro: o que se paga não é a soma dos defeitos, é o que
...
\begin{tabular}{lll}
    ...
    a ordem levada ao relógio declarado & \numRelogioMenosUmDesvios{} desvios & o desvio \\
    a taxa da junta funda & \numFundoAlfaReal & a inclinação \\
    a proteção que de fato protege & \numPrecoRazao{} vezes as margens somadas & o capital \\
...
em que foi medido: a fração, o tempo de mundo, o prejuízo, o erro, a probabilidade, o desvio, a
inclinação, o capital e a promessa. E não tem câmbio entre as três moedas do fio condutor --- dados,
trabalho e memória. As
...
se compra --- e o andar inteiro mostrou o preço disso em todas as moedas que tem: a experiência que
identificaria a causa não existe, o mundo que faltou não se compra, o dia apagado não volta, a margem não
conta o junto, a taxa não se lê de um corte só, e o que sobra disso tem preço em capital:
\numPrecoRazao{} vezes as margens somadas, ou o buraco fica aberto.
...
responder. Quem retomar o trabalho tem tudo isso; e tem, na raiz do livro, a mesma pergunta que o
abriu, agora com o preço ao lado.
