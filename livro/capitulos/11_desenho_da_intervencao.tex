...
O capítulo dos mundos que não bastam deixou duas explicações de pé para a mesma série. Numa, a oscilação de amanhã
...
dizer que o tamanho de hoje depende do tamanho de ontem: o mundo carrega o próprio passado, e o
esquecimento é a taxa com que ele o larga. Onde a memória mora na série, segurar apaga
...
tamanho típico que a barra do primeiro capítulo mediu. A oscilação de hoje é uma mistura de três
