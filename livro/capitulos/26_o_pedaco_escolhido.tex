...
A medição é a do corte, que é a mais simples que a espiral tem: quantos dias rompem o
corte de \numPedacoJanela{} dias. A conta do corte é de \numPedacoPromessa{}, e o teste usa
\numPedacoTamanhos{} tamanhos de pedaço, até \numPedacoMaior{} dias.

Um pedaço é um trecho contíguo da série, com o número de dias declarado --- o mesmo mercado, cortado em
tamanho diferente. A mesma conta, feita em pedaços de \numPedacoMenor{} dias ao longo dos \numPedacoDiasA{} dias do
...
fossem \cite{yu1994rates}. A razão entre a maior e a menor resposta cai de \numPedacoEntregaRazaoDoisAnos{}, nos pedaços
...
também esconde o quanto ela mudou \cite{dahlhaus1998optimal}.
...
\begin{figure}[htbp]
  ...
  \caption{A entrega do corte em cada pedaço de \numPedacoMenor{} dias. A linha tracejada é a
    conta do corte e a faixa cinza é a banda de quem supõe dias independentes. As barras em vermelho são os
    pedaços que caem fora da banda.}
  \label{fig:entrega-por-pedaco}
\end{figure}

O eixo horizontal numera os pedaços e não os data. A figura mostra a resposta variando de ponta a
ponta e deixa fora a que trecho da história pertence cada extremo, de modo que o pedaço escolhido
aparece como número de ordem --- e é essa escolha que o capítulo mede.

Nos \numPedacoPedacosDoisAnos{} pedaços de dois anos, a fração fora da banda de dois desvios da
conta independente é \numPedacoEntregaForaDoisAnos{}, contra \numPedacoEntregaForaCincoAnos{} nos de cinco e
...
preveria --- foi medida nos mesmos tamanhos de pedaço, sobre os \numPedacoDiasComuns{} dias comuns às duas pernas, e ela não se comporta como a entrega do corte\cite{bradley2005basic}.
