...
O mercado fechou, e a pergunta volta quase toda noite com as mesmas palavras: quanto eu
posso perder amanhã? Quem carrega dinheiro aplicado não pergunta por gosto de adivinhar. A
resposta decide se a posição cabe no bolso de quem a carrega, e a posição que não cabe é
desmontada --- muitas vezes antes de o mercado explicar o que estava acontecendo.

Responder exige duas decisões. A primeira é quantos dias olhar para trás. A segunda é onde
pôr a linha dentro desses dias: no pior de todos, no segundo pior, no décimo terceiro. Uma
regra escrita por inteiro soa assim: \emph{o corte de hoje é o décimo terceiro pior dia dos
últimos \numCorteJanela{} pregões}. Ela também traz o que pretende valer: \emph{não passo
daqui, dezenove dias em vinte}, isto é, \numPromessaPct\% de violação.

Vale fixar quatro palavras, porque nenhuma delas muda de sentido daqui em diante: a \textbf{janela} é o pedaço do passado que a regra olha; o \textbf{corte} é onde
a linha é posta dentro da janela; a \textbf{promessa} é a taxa de violação que se anuncia; e
a \textbf{entrega} é a taxa que de fato acontece.

A linha posta no quantil dos piores dias é a medida de risco mais usada em finanças,
discutida e corrigida há décadas \cite{oconnell2026extreme}. O que se pergunta aqui é menos
do que isso, e vem antes: a entrega tem alguma coisa a ver com a promessa?
...
O logaritmo não está ali por elegância. Ele faz um preço que desce e volta ao lugar terminar
com retornos que somam zero, e é isso que permite acompanhar o dia a dia sem perder o fio da
conta:

\[ 100 \to 95: -0{,}0513; \qquad 95 \to 100: +0{,}0513; \qquad \text{queda de } 5\% \text{ pede alta de } 5{,}26\% . \] % numeros-ok: exemplo mínimo

Em porcentagem a volta também acontece, mas com outros números, porque porcentagem
multiplica onde o logaritmo soma.

A série é o índice S\&P 500, % numeros-ok: nome próprio, não medição
com \numSerieDias{} pregões, de \numSerieInicio{} a \numSerieFim. Ela vem do arquivo do
projeto anterior, e o empréstimo fica declarado: o dado atravessa, todo número tirado dele
é medido de novo neste capítulo.
...
\numPromessaPct\% anunciados. A diferença é de um décimo de ponto percentual, e a impressão
que ela deixa é que a regra funcionou.

Aqui a impressão engana. Quem decidiu o número foi a aritmética de erguer a linha, e não o
que o mercado fez.
...
que todas as ordens são igualmente prováveis é a hipótese de que os dias não têm nada a
dizer uns sobre os outros, que é justamente o que um mundo que muda viola. A proposição não
prevê o que vai acontecer. Ela é o contraste contra o qual o que aconteceu se lê.
...
mercado. Veio da decisão de olhar \numCorteJanela{} dias e cortar no décimo terceiro. Se o
posto fosse o décimo segundo, a conta daria \numCorteAlternativoPct\%; e a promessa
anunciada não está em nenhum dos dois, porque o posto teria de cair entre dois dias, e não
existe o décimo terceiro dia e meio de um ano.

O mercado entregou \numEntregaTaxaPct\%: \numEntregaViolacoes{} rompimentos em
\numEntregaDias{} dias, com poucos milésimos de diferença da conta do corte. Para saber se
essa diferença diz alguma coisa, falta o único contraste que responde. É preciso submeter um
mundo em que nada muda exatamente à mesma rotina.
...
pelo calendário, ou concentradas em pedaços. Para medir a forma, contamos quantas
violações caem em cada janela móvel de \numBlocoDias{} dias --- a isso chamamos um
...
teto dos mundos que nunca mudam é cruzado em \numEpisodiosAcimaDoTeto{} episódios distintos,
que ocupam \numBlocosAcimaDoTetoPct\% dos blocos medidos, em \numEpisodiosAnos. Nem todos
esses anos têm nome de crise, e todos aconteceram neste mercado.

A leitura do bloco corrige ainda a primeira impressão: \numBlocoAcimaDoDobroPct\% dos blocos
passam do dobro da promessa. O que se promete não é o que se entrega, nem na maior parte do
tempo, nem nos piores pedaços: é uma média entre os dois.
...
A \textbf{conta do corte} obedece à promessa anunciada apenas na janela longa. Na janela de
um mês, o corte assina \numCorteCurtoContaPct\%, quase o dobro dos \numPromessaPct\%
anunciados, e a razão é aritmética, não mercado: com poucos dias não existe corte que produza
\numPromessaPct\%.
...
pedaço ruim. Na janela de cinco anos o pior bloco chega a \numCorteLongoPiorBloco. No
extremo oposto, uma janela curta não compra bloco nenhum: o pior bloco do mundo real,
...
entregue o que a promessa anunciou, e a razão disso é a \cref{prop:conta}, que não deixa o
...
série deste capítulo não se parece consigo mesma: passa meses colada na linha e depois rompe
a linha \numBlocoPior{} vezes em \numBlocoDias{} dias, com o pior bloco terminando em
\numBlocoPiorData.

Quando isso acontece, a linha não erra por pouco. Ela foi erguida com os dias de antes, e
são justamente esses dias que deixaram de valer. A \cref{tab:varredura} já mostrava o mesmo
por outro caminho: quanto mais longo o passado que a linha olha, mais tempo ela leva para
acompanhar o que mudou, e mais violações cabem no pedaço ruim.

Se os blocos têm data, alguma coisa no mundo não é fixa, e a média não é o instrumento que a
vê. Resta medir essa mudança, e é o que os capítulos seguintes fazem.
