...
discutida e corrigida há décadas \cite{oconnell2026extreme}. O quantil de uma fração declarada é o
valor que deixa essa fração dos dias abaixo dele, e é ele que o corte deste capítulo usa. O que se pergunta aqui vem antes
...
da fila dos $n+1$ valores. Logo a probabilidade é $k/(n+1)$.
\end{proof}
