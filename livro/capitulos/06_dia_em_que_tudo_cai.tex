% =============================================================================
% CAPÍTULO 6 — volta 1, a última forma: a dependência que a margem não vê.
%
...
% capítulos 3 e 5 pode ver isso — a informação não está em nenhuma das duas séries.
%
...
dependência delas depois de cada uma ter sido padronizada pela própria margem: ela descreve a
junta inteira, e para isso tem de ser escolhida --- e escolher errado erra na cauda, que é onde a
conta é paga.
