...
de margem não vê o que acontece **entre** as pernas, e ler uma série pelo segundo momento é ler
...
diferente. A família usada aqui tem a correlação **declarada**: com probabilidade $p$ as duas pernas
...
O que não é honrado é o que acontece **depois** do rompimento. A profundidade média além do corte vai
...
correlação. A margem **não** é cega à cauda: ela conta que a cauda engordou, e conta pela taxa e pela
profundidade. O que ela não conta é a **junto**; e como o prejuízo de uma carteira é feito de dias em
