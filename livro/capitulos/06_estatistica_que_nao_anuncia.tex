...
igual à do mercado. Aplicados os quatro sinais, o resultado é este.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrr}
    ...
    \hline
  \end{tabular}
  \caption{Os mesmos quatro sinais nos dois mundos. No mundo em que nada muda não há o que
