...
mostra a média do alvo em cada uma: ele dá a forma da relação, que um número só não dá. É também
na cauda que a relação deixa de ser linear, e a cauda é onde a conta é paga.
% aterramento: cauda
