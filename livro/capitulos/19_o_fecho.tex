...
Este capítulo mede a promessa do primeiro capítulo com **três buracos abertos ao mesmo tempo**: a
janela da calibração, o atraso do dado e o mundo. A promessa é a mesma em todas as
\numFechoConfiguracoes{} configurações --- \numFechoPromessa{} dos dias rompendo o corte, com o posto
acompanhando a janela para que a taxa anunciada não mude ---, com \numFechoJanelas{} tamanhos de
janela em mundos de \numFechoDias{} dias. A pergunta é se os buracos somam ou se compõem.
...
\begin{table}[htbp]
  ...
  \caption{A promessa medida nas \numFechoConfiguracoes{} configurações, em
    ...
    a mudança. A última coluna é a entrega dividida pela promessa.}
  \label{tab:pilha}
\end{table}

A primeira metade da tabela traz o mundo parado, e ali a lição é conhecida: a janela longa entrega
\numFechoParadoLongaSemAtraso{} vez a promessa e a curta \numFechoParadoCurtaSemAtraso{}, de modo que
mais memória é melhor; o atraso não move nada de importante.

A segunda metade inverte a ordem. Com o mundo dobrando, a janela longa entrega
\numFechoMudadoLongaComAtraso{} vezes a promessa e a curta \numFechoMudadoCurtaSemAtraso{}: **a
...
mesma promessa: a janela longa custa \numFechoSoJanelaParado{} vez a promessa num mundo parado e
\numFechoSoJanelaMudado{} num mundo que muda, o atraso de
\numFechoAtraso{} dias custa \numFechoSoAtrasoParado{}, e a mudança sozinha custa
\numFechoSoMudanca{}.

Somando os efeitos isolados chega-se a \numFechoSomaIsolada{} vezes. A pilha inteira --- janela
...
\begin{figure}[htbp]
  ...
  \caption{O preço de cada buraco sozinho e o da pilha inteira, em vezes a promessa. A barra verde é
    maior do que a soma das outras, e é essa diferença que o livro inteiro perseguiu.}
  \label{fig:pilha}
\end{figure}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lll}
    ...
    o orçamento do alarme & \numTrocaDozeAnos{} anos por alarme falso & o tempo de mundo \\
    o que ele paga no tombo & \numTrocaDozePagoPct{}\% do prejuízo & o prejuízo \\
    ...
    o atraso do dado & \numAgoraRazaoDuzentosECinquentaEDois{} vez a promessa & a fração \\
    a direção do tempo & \numDirecaoIndiceRazao{} desvios & o desvio \\
    quem cai primeiro & \numConjuntaDesvios{} desvios & o desvio \\
    a pilha dos buracos & \numFechoPilha{} vez a promessa & a promessa \\
    \hline
  \end{tabular}
...
A tabela diz o que o livro tem e o que ele não tem. Tem preço para quase tudo: dias de memória,
dias de experimento, dias de atraso, trabalho de atualização, bits, alarmes por ano, desvios e
frações. E não tem câmbio entre as três moedas do fio condutor --- dados, trabalho e memória. As
...
A hipótese do fio condutor fica, então, com o veredito que a medição sustenta: **promessa e entrega
são a mesma pergunta em três lugares, e os três lugares não têm a mesma régua**. Quem tentar somar
dias de memória com dias de trabalho vai errar por uma ordem de grandeza; quem mantiver as três
...
**O que se pode garantir.** Uma promessa declarada, com o preço declarado ao lado: o instrumento
entrega \numFechoPromessa{} dos dias num mundo parado, o preço em alarmes falsos está na
\cref{tab:balanco}, e o que se paga quando o mundo muda está na \cref{tab:pilha}. Garantia sem preço
não é garantia, é frase.

**O que se pode medir.** A entrega, contra a promessa, sempre com a dispersão --- entre mundos
...
**O que se pode otimizar.** As bordas, e só elas: quanto passado entra na conta, de quando é o dado,
