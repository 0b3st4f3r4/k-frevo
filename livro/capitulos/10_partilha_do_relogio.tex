...
\begin{figure}[htbp]
  ...
  \caption{À esquerda, a perda contra a fração do orçamento que vai para a escala, com a dispersão
    entre mundos, contra a fração do orçamento num eixo logarítmico. À direita, o ganho da melhor
    partilha contra o tamanho do orçamento: a vantagem de escolher bem encolhe quando o orçamento
    engorda.}
  \label{fig:partilha}
\end{figure}
