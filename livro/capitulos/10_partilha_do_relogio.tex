...
que sobra é a da travessia entre proteger e adaptar: **recalibrar a barreira compete com acompanhar
o mundo?**
...
A última conta fecha o sentido do capítulo. Atualizar tudo todo dia custa
\numPartilhaSobra{} de perda por dia, contra \numPartilhaMelhor{} do melhor desenho com
\numPartilhaOrcamento{} atualizações: \numPartilhaGanhoSobraPct\% menos perda, comprada com
\numPartilhaSobraAtualizacoes{} atualizações de cada ingrediente no mesmo horizonte. A pergunta que
fica não é se vale a pena, mas quanto se está disposto a pagar por um punhado de perda.
...
janela sem tirar nada do outro. O que se gasta é o **trabalho** de refazer a conta, e aí a
...
atualizada sempre, e atualizar é, no fundo, **esquecer**: cada atualização troca passado por
