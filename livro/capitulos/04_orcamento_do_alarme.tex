...
duas precisam de resposta junta, porque cada uma é paga com a outra\cite{ramdas2021hypothesis} \cite{wald1945sequential}.
...
curva, com o preço da esquerda pago em falso alarme e o da direita pago em atraso\cite{halme2026sequential}.
...
o erro de contagem que a \cref{prop:teto} limita por cima\cite{shin2022detectors}. Na leitura do dia a frequência é
...
E fica o fracasso seguinte, e ele não é sobre o mundo: é sobre o número. Aquele par foi declarado
para quem pergunta uma vez --- e o limiar que o assina foi escolhido olhando o tombo. Quanto disso é
do limiar e quanto é do procedimento que o escolheu é a pergunta que o capítulo seguinte faz, e a
resposta muda o que se pode prometer a quem olha o alarme todo dia.
