...
isso tem uma coisa em comum, e é o que a travessia vem testar: **cada instrumento lê uma margem**,
...
olhar uma série consegue ver uma mudança que existe apenas **entre** duas? O capítulo da
...
A pergunta é sobre estrutura e não sobre o mundo (AGENTS.md, seção 8), e por isso a mudança é posta de
...
O primeiro instrumento é o que os capítulos 2 e 3 construíram: o corte no décimo terceiro pior dos
...
antes e \numVizinhancaTaxaBDepois{} depois. A variação é de quatro décimos de milésimo.

A leitura desse número não é que o vigia é insensível, nem que está mal calibrado. É que ele não
tem o que ver: as duas séries que ele observa são **as mesmas** antes e depois, e a mudança vive
...
O instrumento que vê já existe desde o capítulo da dependência: contar os dias em que as **duas**
...
capítulo 2, medida agora para a dependência.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrrr}
    ...
    (dias conjuntos por bloco) & (anos por alarme falso) & (dias) & (de \numVizinhancaSementes) \\
    \hline
...
muda **não produz o evento** dentro dos seis mil dias observados, e o orçamento deixa de ser
...
capítulo 2, no orçamento de um alarme por ano: ali, a mudança que vem pela cauda é vista em
...
que vai de duas a cinquenta vezes, conforme a forma da mudança com que se compare --- e o
orçamento dele já é mais silencioso que o do vigia de margem, de modo que a comparação é generosa
com ele.

Vale dizer o que isso significa sem anestesia: **a dependência é o objeto mais caro deste livro
...
\cref{tab:vizinhanca} não foi suposto: ele foi medido no mundo em que o par **não** muda. Com o
...
Fica a primeira resposta da travessia, e ela é limpa: **o vigia de margem não vê dependência** ---
