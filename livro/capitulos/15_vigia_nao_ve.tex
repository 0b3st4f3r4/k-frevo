% =============================================================================
% CAPÍTULO 15 — travessia (AGENTS.md §6): F1, o vigia vê dependência?
%
...
As voltas anteriores ensinaram a medir uma série --- e o corte está fora delas, na raiz: o orçamento, a
célula do calendário, a dependência entre duas pernas, a estatística que estima e a que anuncia, o
conjunto de explicações que sobrevivem ao dado, e a lei que anda. Tudo
isso tem uma coisa em comum, e é o que a travessia vem testar: \textbf{cada instrumento lê uma margem},
e algumas mudanças não estão em margem nenhuma \cite{ansari2021sklar}.

A primeira pergunta é a mais direta de todas. Um vigia construído para
olhar uma série consegue ver uma mudança que existe apenas \textbf{entre} duas? O capítulo da
dependência já mostrou que as coisas ruins vêm juntas mais do que a independência prevê; o que se mede aqui é outra coisa: se o vigia que este livro construiu detecta o dia em que elas
passam a vir juntas.
...
A pergunta é sobre a estrutura do par e não sobre o que o mercado faz, e por isso a mudança é posta de
...
pernas rompem o próprio corte, em blocos móveis, e comparar com o que a independência preveria
\cite{garcin2026nonparametric}. A
mesma contagem, aqui, antes e depois do fim da janela da margem, que é a linha que a figura
desenha: \numVizinhancaConjuntoAntes{} por bloco antes, \numVizinhancaConjuntoDepois{} depois.
...
que vai de pouco mais de duas vezes a cinquenta vezes, conforme a forma da mudança com que se
compare --- e o
orçamento dele já é mais silencioso que o do vigia de margem, o que só aumenta a distância: um alarme mais raro chega mais
tarde, como a \cref{tab:vizinhanca} mostra ao subir do limiar dois ao quatro.
...
\begin{figure}[htbp]
  ...
  \caption{A contagem conjunta, dia a dia, com a janela da margem e o limiar do instrumento conjunto. Antes da
...
o objeto de uma família e medi-lo com o instrumento de outra. É onde a lista cresce
sozinha, e é onde a organização por assunto deixa de valer.
