...
A travessia fechou com um preço em cada pergunta, e o andar já abriu com a experiência que não
existe. Este capítulo segue na conta mais dura de todas: de que serve uma proteção calibrada no
que já se viu, quando o prejuízo é decidido pelo mundo que não se viu?
...
quando é pior do que todos eles. Dimensionar a proteção por ele tem duas falhas, e as duas se
medem.

A primeira é que o pior dia do registro não é um teto, e a chance
...
As duas probabilidades acima saem de uma contagem, e a contagem é a mesma do corte.
...
\numRecordeFracaoTriplo{}, e a conta de permutabilidade --- que é a mesma do corte ---
erra para o lado otimista. Quem dimensiona pelo pior dia do registro, e acrescenta a margem que a
conta sugere, está protegido contra o mundo que não mudou e descoberto contra o que mudou\cite{taleb2020machine}.
