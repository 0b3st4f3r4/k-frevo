...
\begin{figure}[htbp]
  ...
  \caption{A latência mediana de cada instrumento, forma por forma: a contagem de rompimentos
    ...
    parado produz no primeiro deles, e a barra cheia é o instrumento que ficou sem alarme dentro
    do horizonte --- duas barras que terminam no mesmo lugar não são empate, porque uma delas
    não chegou.}
