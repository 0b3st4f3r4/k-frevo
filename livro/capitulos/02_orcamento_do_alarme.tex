...
\begin{figure}[htbp]
  ...
  \caption{A latência mediana de cada instrumento, forma por forma: a contagem de rompimentos
    ...
    cego à deriva. As barras cheias querem dizer que o instrumento não viu dentro do horizonte, e duas barras que terminam no mesmo lugar não são empate: uma delas não chegou.}
