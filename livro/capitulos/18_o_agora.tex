...
primeiro capítulo, e a identidade é conferida pelo teste da biblioteca --- o atraso não muda o
instrumento, muda a idade do dado que ele lê.

Medida no índice, ao longo dos \numAgoraDias{} dias, a entrega do corte com atraso é esta.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{rrr}
    ...
    \hline
  \end{tabular}
  \caption{A entrega do corte contra a idade do dado, no índice. A promessa é de
    \numAgoraPromessa{}, e é ela que a última coluna toma por referência.}
  \label{tab:atraso-do-dado}
\end{table}

Um dia de atraso não se nota. Um ano de atraso entrega \numAgoraRazaoDuzentosECinquentaEDois{} vez o
prometido: o instrumento passa a romper \numAgoraEntregaDuzentosECinquentaEDois{} dos dias onde
...
No mesmo experimento em \numAgoraSementes{} mundos que **não** mudam, a entrega do corte com atraso
de nenhum atraso a \numAgoraAtrasoMaior{} dias fica entre
\numAgoraParadoMenor{} e \numAgoraParadoMaior{} --- uma variação de \numAgoraParadoVariacao{}. O
atraso de um ano move a taxa no quarto decimal: de \numAgoraParadoZero{} no atraso nenhum a
\numAgoraParadoVinteEUm{} em vinte e um dias.

O motivo é o instrumento: o corte é um quantil, e um quantil não sabe que dia é hoje. Num mundo cuja
distribuição não se mexe, a barreira de um ano atrás vale tanto quanto a de ontem. **O atraso não
cobra dias; ele cobra a mudança que coube dentro dele.**

\section{O que ele cobra, então}

Para ver a cobrança é preciso olhar onde o mundo muda. O mundo do controle dobra de uma vez no meio
...
Com este capítulo o enquadramento fecha, e ele fecha numa imagem só. No instante da decisão, o que
um sistema tem é um **retângulo**. O eixo do tempo vai até \emph{t} menos o atraso, e
para trás até \emph{t} menos o atraso menos a memória.
...
Fica a regra do andar do enquadramento, e ela vale para qualquer medição futura: **declarar as três
