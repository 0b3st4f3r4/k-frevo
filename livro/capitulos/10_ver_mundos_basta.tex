% =============================================================================
% CAPÍTULO 10 — volta 4 (AGENTS.md §6): ver mundos basta, ou é preciso mexer no mundo?
%
...
mercado só tem a sua escala \cite{peters2016causal}\cite{scholkopf2021causal}.\cite{ghassami2017learning}\cite{li2025feature}\cite{scholkopf2021causalb} Se for assim, observar mais mundos identifica o mecanismo, e a
...
que variam no tempo \cite{palma2010efficient}\cite{dahlhaus2006nonparametric}\cite{palma2013estimation} --- ainda não foi testada, e é o único caminho que mantém vivo o refutador
