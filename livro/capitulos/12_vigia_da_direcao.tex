...
simétrico --- \numDirecaoSementes{} mundos sorteados de \numDirecaoBlocosPorMundo{} blocos cada,
\numDirecaoBlocosNulo{} blocos no total ---, a dispersão da
...
dois deles são os anos de quebra, com a estatística em \numDirecaoIndiceDispersaoBlocos{} de dispersão
puxada por eles. Um vigia que decide ao fim de cada ano mede se aquele ano teve um tombo, e a seta do tempo fica para
depois.
