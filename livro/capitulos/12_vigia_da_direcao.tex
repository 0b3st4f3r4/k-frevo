...
ser **vigiada**, e vigiada com garantia.
...
simétrico --- \numDirecaoSementes{} mundos sorteados de \numDirecaoBlocosPorMundo{} blocos cada ---, a dispersão da
...
Os três mercados têm, então, direção, e ela é grande: \numDirecaoBitcoinRazao{} desvios no Bitcoin. O
Ibovespa entra na mesma conta com \numDirecaoIbovespaDias{} dias, que dão
\numDirecaoIbovespaBlocos{} blocos de um ano.
...
\numDirecaoIndiceMomento{}, quase o dobro disso. E a primeira linha mostra o preço: no mundo sem
...
contra \numDirecaoNuloDispersao{} lá. O vigia de bloco de um ano mede, então, o **caráter do ano** ---
...
\numDirecaoIndiceAcertoHonesto{} dos anos --- e dois deles são os anos de quebra, com a estatística em
\numDirecaoIndiceDispersaoBlocos{} de dispersão puxada por eles. Um vigia que decide ao fim de cada ano mede se aquele ano teve um tombo, e a seta do tempo fica para
depois.
...
direção de **uma** série. Quando as coisas ruins vêm juntas, há uma segunda pergunta de direção, e ela é sobre outra
