...
O dia tem um número de ordem, o índice $t$; o preço daquele dia é $p_t$, e o do dia seguinte é
$p_{t+1}$. O retorno de um dia para o outro sai da razão entre os dois preços.
% aterramento: r
% aterramento: t
\[
...
O logaritmo está ali por um motivo prático: ele é a operação que troca multiplicação por soma
--- o logaritmo de um produto é a soma dos logaritmos dos fatores. Ele faz um preço que desce e
volta ao lugar terminar com retornos que somam zero, e é isso que permite acompanhar o dia a dia
sem perder o fio da conta:
