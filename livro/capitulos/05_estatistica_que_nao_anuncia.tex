...
volatilidade tem memória, e isso é sabido. E há um terceiro número, maior que os outros dois: o
...
\numEstabilidadeFaixaAltaNivelPosto{} na agitada. O nível sobrevive ao corte da oscilação.
...
\begin{figure}[htbp]
  ...
  \caption{O futuro médio em cada décimo dos quatro sinais, com a média geral como linha. Três
    dos quatro sobem; o do movimento do corte atravessa o gráfico de lado.}
  \label{fig:decimos}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{O nível do corte e a contagem recente medidos dentro de três faixas de oscilação,
    onde a oscilação de agora é quase a mesma. O nível não desaparece ao dividir por ela.}
  \label{fig:faixas}
\end{figure}
