...
% aterramento: theta
horizonte sai da conta: $\log(1-\theta^{2})$ dividido por $2\log a$ dias --- e $\theta$ é a
fração do degrau que ainda se quer recuperar, o quanto do passado se aceita perder antes de dizer
que ele voltou.
