...
\begin{figure}[htbp]
  ...
  \caption{Até onde cada família alcança o agrupamento do dado. A linha tracejada é o pior bloco
    que a série produziu; as barras são quantos membros de cada família chegam a cada valor.}
  \label{fig:alcance}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{O conjunto factível no plano dos dois primeiros parâmetros, para a permanência longa.
    ...
    estatísticas. A mancha escura da esquerda é o tamanho do que a média não decide.}
  \label{fig:factivel}
\end{figure}
