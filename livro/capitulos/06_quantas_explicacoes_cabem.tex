% =============================================================================
% CAPÍTULO 6 — volta 3 (AGENTS.md §6): a geometria do condicionamento.
%
...
agitado. O segundo é a razão entre as duas leis, isto é, quantas vezes o dia agitado é mais
...
Vale ler esse número devagar. Trinta e quatro explicações diferentes --- com frações agitadas
distintas e razões distintas entre as leis --- reproduzem o mesmo número que o primeiro capítulo levou
vinte páginas para discutir. A promessa, sozinha, não identifica nada; ela é compatível com quase
...
Não é que o conjunto encolha para poucas explicações: ele fica vazio. A família de duas leis, com
o estado sorteado de novo a cada dia, **não alcança** o agrupamento que o dado tem, e o teste é
...
que nunca mudam à mesma rotina, o pior bloco de todos eles parou em treze. A família deste
capítulo bate no mesmo teto, e pelo mesmo motivo: sem memória, os dias ruins não têm como se
agrupar.
...
dia a família é a anterior, sem memória.
...
bloco, cabem doze. Com as quatro estatísticas, cabem
...
Uma explicação que reproduz as quatro estatísticas de uma série de vinte e seis anos com dois
parâmetros e uma permanência é pouco. Duas explicações que as reproduzem são o resultado honesto
deste capítulo: o dado identifica uma **região**, e não um ponto.
...
\begin{figure}[htbp]
  ...
  \caption{O conjunto factível no plano dos dois primeiros parâmetros, para a permanência longa.
    À esquerda, os membros que reproduzem apenas a taxa; à direita, os que reproduzem as quatro
    estatísticas. A mancha escura da esquerda é o tamanho do que a média não decide. A cor conta quantas estatísticas cada ponto satisfaz, e não quão bom é o ajuste: claro não é aprovação.}
  \label{fig:factivel}
\end{figure}

O mapa da \cref{fig:factivel} diz o mesmo em duas dimensões. Na permanência mais longa,
\numCondicionamentoPontosSoATaxa{} dos \numCondicionamentoCombinacoes{} pontos do plano reproduzem apenas
...
por mim, e uma tolerância frouxa admite mais explicações por construção. A conta foi repetida com
...
Vale a distinção, porque ela reaparece em tudo o que vem: **refutação é do dado; tamanho de
