...
agrupamento em \numObservarAcertoUnicaIndice\% das tentativas no primeiro mercado,
\numObservarAcertoUnicaIbov\% no segundo e \numObservarAcertoUnicaBitcoin\% no terceiro. Com a
duração heterogênea, os mesmos três números caem para \numObservarAcertoHeteroIndice\%,
\numObservarAcertoHeteroIbov\% e \numObservarAcertoHeteroBitcoin\%.
